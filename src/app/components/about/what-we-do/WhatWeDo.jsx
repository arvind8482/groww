                ...
                <div className='w-full xl:w-1/2 '>
                    ...
                    At VisionGroww, we specialize in delivering top-tier IT services to help your business excel in the digital age. Our diverse offerings include:
                      ...
                      <ul className='text-default-size xl:ps-6 py-6 '>
                            ...
                            <li className='bg-list bg-[left_5px] bg-no-repeat ps-8 '><strong>Master Classes :</strong>  Elevate your expertise with our hands-on master classes in Data Science, essential DevOps tools, Cloud Certification preparation, Full Stack Development, and Database Management.</li>
                        </ul>
                </div>
              
            </div>
            <p className='text-default-size xl:pt-8 px-6 text-center'>
