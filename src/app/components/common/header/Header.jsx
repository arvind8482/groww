...
export default function Header() {
  ...
  return (
    <header className="bg-white px-6 sticky top-0 z-50 border-b-2">
      ...
      <Dialog open={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)} className="xl:hidden">
        <div className="fixed inset-0 " />
        <DialogPanel className="fixed inset-y-0 right-0 w-full overflow-y-auto sm:ring-1 sm:ring-gray-900/10 bg-white">
 
          <div className="mt-8 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 pt-6 p-6">
                <Link
                  href="/"
                  className="-mx-3 block rounded-lg px-3 pt-12 pb-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
